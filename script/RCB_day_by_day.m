...
system = 'BDS-3';      % Choose: GPS, GLONASS, Galileo, QZSS, BDS-2, BDS-3
...
points_per_day = total_pts / 24;  
tick_positions = [1, points_per_day*6+1, points_per_day*12+1, points_per_day*18+1, total_pts];
